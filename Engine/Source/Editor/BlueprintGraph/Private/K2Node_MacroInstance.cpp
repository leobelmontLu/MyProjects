...
void UK2Node_MacroInstance::NotifyPinConnectionListChanged(UEdGraphPin* ChangedPin)
{
	...
	//Changed by swd for map begin 2019年1月30日10:37:14
	bool bHasMap = false;
	...
	if (bHasMap)
	{
		if (ChangedPin->LinkedTo.Num() > 0)
		{
			...
			if (bIsWildcardPin)
			{
				const FEdGraphPinType& LinkedPinType = ChangedPin->LinkedTo[0]->PinType;

				bool bIsMap = false;
				bool bIsKey = false;
				bool bIsValue = false;
				const TCHAR* ValuePrefix = TEXT("Value");
				if (ChangedPin->PinType.IsMap())
				{
					bIsMap = true;
				}
				else if (ChangedPin->PinName.ToString().StartsWith(ValuePrefix))
				{
					bIsValue = true;
				}
				else
				...
				for (UEdGraphPin* const TmpPin : Pins)
				{
					if (TmpPin)
					{
						FEdGraphPinType& PinType = TmpPin->PinType;
						if (PinType.PinCategory == UEdGraphSchema_K2::PC_Wildcard)
						{
							if (PinType.IsMap())
							{
								if (bIsMap)
								{
									PinType = LinkedPinType;
								}
								else if (bIsKey)
								{
									PinType.ResetToDefaults();
									PinType.PinCategory = LinkedPinType.PinCategory;
									PinType.PinSubCategory = LinkedPinType.PinSubCategory;
									PinType.PinSubCategoryObject = LinkedPinType.PinSubCategoryObject;
									PinType.bIsConst = LinkedPinType.bIsConst;
									PinType.bIsWeakPointer = LinkedPinType.bIsWeakPointer;
								}
								else if (bIsValue)
								{
									PinType.PinValueType.TerminalCategory = LinkedPinType.PinCategory;
									PinType.PinValueType.TerminalSubCategory = LinkedPinType.PinSubCategory;
									PinType.PinValueType.TerminalSubCategoryObject = LinkedPinType.PinSubCategoryObject;
									PinType.PinValueType.bTerminalIsConst = LinkedPinType.bIsConst;
									PinType.PinValueType.bTerminalIsWeakPointer = LinkedPinType.bIsWeakPointer;
								}
							}
							else if (TmpPin->PinName.ToString().StartsWith(ValuePrefix))
							{
								if (bIsMap)
								{
									const FEdGraphTerminalType& PinValueType = LinkedPinType.PinValueType;
									PinType.ResetToDefaults();
									PinType.PinCategory = PinValueType.TerminalCategory;
									PinType.PinSubCategory = PinValueType.TerminalSubCategory;
									PinType.PinSubCategoryObject = PinValueType.TerminalSubCategoryObject;
									PinType.bIsConst = PinValueType.bTerminalIsConst;
									PinType.bIsWeakPointer = PinValueType.bTerminalIsWeakPointer;
								}
								else if (bIsValue)
								{
									PinType.ResetToDefaults();
				...
				{
					ResolvedWildcardType.PinValueType.TerminalCategory = LinkedPinType.PinCategory;
					ResolvedWildcardType.PinValueType.TerminalSubCategory = LinkedPinType.PinSubCategory;
					ResolvedWildcardType.PinValueType.TerminalSubCategoryObject = LinkedPinType.PinSubCategoryObject;
					ResolvedWildcardType.PinValueType.bTerminalIsConst = LinkedPinType.bIsConst;
					ResolvedWildcardType.PinValueType.bTerminalIsWeakPointer = LinkedPinType.bIsWeakPointer;
				}
				else
				{
					ResolvedWildcardType.PinCategory = LinkedPinType.PinCategory;
					ResolvedWildcardType.PinSubCategory = LinkedPinType.PinSubCategory;
					ResolvedWildcardType.PinSubCategoryObject = LinkedPinType.PinSubCategoryObject;
					ResolvedWildcardType.bIsConst = LinkedPinType.bIsConst;
					ResolvedWildcardType.bIsWeakPointer = LinkedPinType.bIsWeakPointer;
				}
	...
	//Changed by swd for map end 2019年1月30日10:37:14
