...
//Added by swd@BlueSnail @begin 2019年7月10日15:44:13
const FName UEdGraphSchema_K2::PC_UInt(TEXT("uint"));
//const FName UEdGraphSchema_K2::PC_Int64(TEXT("int64"));
const FName UEdGraphSchema_K2::PC_UInt64(TEXT("uint64"));
const FName UEdGraphSchema_K2::PC_Double(TEXT("double"));
//Added by swd@BlueSnail @end 2019年7月10日15:44:13
